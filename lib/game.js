(function () {
  ...
  Game.prototype.showIntro = function () {
    $('#status-bar').empty();
    str = "<h1>CRYSTAL QUEST</h1><br><button id='start'>Start</button><br><button id='high-scores'>High Scores</button>"
    $('#controls').append(str);
  };

  Game.prototype.showHighScores = function () {
    str = "<h1>HIGH SCORES</h1><br><button id='start-menu'>Back to Start Menu</button>"
    $('#controls').append(str);
  };
