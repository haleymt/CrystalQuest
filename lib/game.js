(function () {
  ...
  Game.prototype.run = function () {
    ...
    $('#controls').on('click', '#start', function () {
      this.counter = 0;
      $('#controls').empty();
      $('#status-bar').append('<ul><li>Score: <t id="score">0</t></li><li id="lives"><img src="./life.png" width="25"><img src="./life.png" width="25"></li><li id="bombs"><img src="./bomb.png" height="15"><img src="./bomb.png" height="15"><img src="./bomb.png" height="15"><t id="bomb-count"></t></li><li>Wave: <t id="wave">1</t></li><li>Time: <t id="time">00:00</t></li>');
