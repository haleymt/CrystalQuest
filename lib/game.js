(function () {
  ...
  Game.prototype.win = function() {
    ...
    var timeBonus = Math.floor((5000 / seconds) * 500)
    var content = "<p>Wave number " + $('#wave').text() + " completed</p><p>Time taken: " + timeTaken + "</p><p>Time bonus: " + timeBonus + "</p><br><button id='next-level'>Next Level</button>"
